# Aimee module: governance

This is the independent `governance` source-ownership repository.

It builds `aimee-module-governance` as a separate Go process for the
